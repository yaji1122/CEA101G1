				...
				<tbody>
					...
					<c:forEach var="mealOrderVO" items="${mealOrderList}" varStatus="i">
						<tr>
							...
							<form id="form${i.index}" method="post" action="${pageContext.request.contextPath}/MealOrderDetailServlet">
								<input type="hidden" name="meal_odno" value="${mealOrderVO.meal_odno}">
								<input type="hidden" name="action" value="getOneMealOrderDetail">
								<a href="#"onclick="document.getElementById('form' + ${i.index} + '').submit();" style="text-decoration: none; color: brown;">
									${mealOrderVO.meal_odno}
								</a>
							</form>
							</td>
