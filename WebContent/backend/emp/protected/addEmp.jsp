...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/back/addEmp.css" />
...
<div class="container mt-5">
                <div class="row d-flex justify-content-center">
                   ...
                   <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/emp/emp.do" name="form1" enctype="multipart/form-data" onclick="return false">
                                     <img src="<%=request.getContextPath()%>/img/people.png" width="100" class="rounded-circle" />  
                                        <span class="d-block head">姓名</span>
                                        <input type="TEXT" name="emp_name"  
			                             value="<%= (empVO==null)? "Sam" : empVO.getEmp_name()%>" placeholder="Name" required/>
		                            
			                            <span class="d-block head">電子信箱</span>
                                            <input type="email" name="emp_email" 
			                              value="<%= (empVO==null)? "123@gmail.com" : empVO.getEmp_email()%>" placeholder="Email" required/>
...
<jsp:useBean id="titleSvc" scope="page" class="com.title.model.TitleService" />
                                            ...
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                <span class="d-block head">員工照片</span>
                                ...
                                <div class="col-md-5">
                                    <div class="py-3">
                                           ...
                                           <div class="checkbox">
                                             <jsp:useBean id="funcSvc" scope="page" class="com.func.model.FuncService" />  
                                                   <c:forEach var="funcVO" items="${funcSvc.all}"> 
                                                    <div><input type="checkbox" id="checkbox1" value="${funcVO.func_no}" name="function">
                                       ...
                                       <div class="px-3">
                                            ...
                                            <input type="button" id="add" class="btn btn-primary btn-block" value="送出新增" 
                                            onClick="populateform(8)">
                                        </div> </FORM>
                                </div>
                            </div>
                        </div>
  ...
  <script>
            ...
            console.log(add);
            add.addEventListener("click", check,false);
            function check(){
            	console.log("123");
