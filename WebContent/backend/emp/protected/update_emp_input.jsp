      ...
      <div>
         <div class="card" style="width:30rem;">
            <button class="btn"><i class="fa fa-home">
              <a href="<%=request.getContextPath()%>/emp/emp.do?emp_id=${empVO.emp_id}&action=getOne_For_Display"> Back</a></i></button>
                <div class="listOne">
                   <div class="left">
                      <img src="${pageContext.request.contextPath}/emp/emp.do?emp_id=${empVO.emp_id}&action=getEmpPic">
                      <input type="file" name="emp_pic" size="45" value="${empVO.emp_pic}" />
                       <h5 class="mt-2"><input type="text" name="emp_name" value="${empVO.emp_name}" placeholder="Name"></h5>
