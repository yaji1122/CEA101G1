          ...
          <tr>
            ...
            <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td width="80%">
                    <h1 class="sm-text-lg all-font-roboto" style="font-weight: 700; line-height: 100%; margin: 0; margin-bottom: 4px; font-size: 24px;">Customer Invoice</h1>
                  ...
                  <td style="text-align: right;" width="20%" align="right">
                    <a href="<%=request.getContextPath()%>/receipt.jsp?bk_no=${bkod.bk_no}" target="_blank" style="text-decoration: none;">
              ...
              <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
              	<tr>
                  <td class="sm-inline-block" style="color: #718096;" width="50%">Invoice No#</td>
                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">${bkod.bk_no}</td>
                </tr>
                <tr>
                  <td class="sm-inline-block" style="color: #718096;" width="50%">Customer</td>
                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">${member.mb_name}</td>
                </tr>
                <tr>
                  <td class="sm-inline-block" style="color: #718096;" width="50%">Guests</td>
                  <jsp:useBean id="detailSvc" scope="page" class="com.bookingdetail.model.BookingDetailService"/>
                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">${detailSvc.getAllByBkNo(bkod.bk_no).stream().map(e -> e.rm_guest).sum()} Adult</td>
                </tr>
                <tr>
                  <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Stay</td>
                  <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">${bkod.dateOut.compareTo(bkod.dateIn)} Night</td>
                </tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
              ...
              <table style="font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td class="sm-w-full sm-inline-block sm-text-center" width="40%">
                    ...
                    <p class="all-font-roboto" style="font-weight: 600; margin: 0; color: #000000; letter-spacing:1px">${bkod.dateIn.format(DateTimeFormatter.ofPattern("yyyy MMM dd"))}</p>
                  </td>
                  ...
                  <td class="sm-w-full sm-inline-block sm-text-center" style="text-align: right;" width="40%" align="right">
                    ...
                    <p class="all-font-roboto" style="font-weight: 600; margin: 0; color: #000000; letter-spacing:1px">${bkod.dateOut.format(DateTimeFormatter.ofPattern("yyyy MMM dd"))}</p>
                  </td>
                </tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
              ...
              <table style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td style="color: #718096;" width="50%">Price per person(tax include)</td>
                  <td style="font-weight: 600; text-align: right;" width="50%" align="right">\$${bkod.total_price / detailSvc.getAllByBkNo(bkod.bk_no).stream().map(e -> e.rm_guest).sum()}0</td>
                </tr>
                <tr>
                  <td style="font-weight: 600; padding-top: 32px; color: #000000; font-size: 20px;" width="50%">Total</td>
                  <td style="font-weight: 600; padding-top: 32px; text-align: right; color: #68d391; font-size: 20px;" width="50%" align="right">\$${bkod.total_price}</td>
                </tr>
              </table>
            </td>
          </tr>
