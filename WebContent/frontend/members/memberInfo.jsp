...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/front/creditCard.css" />
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/front/memberInfo.css" />
        ...
        <div class="main-wrapper">
            <div class="select-div">
                <div class="side-nav">
                    <ul>
                        <li>
                            <a href="<%=request.getContextPath()%>/frontend/members/memberInfo.jsp"><i class="far fa-user"></i> 個人資訊</a>
                        </li>
                        <li>
                            <a href="#"><i class="far fa-calendar-check"></i> 假期管理</a>
                        </li>
                        <li>
                            <a href="#"><i class="fas fa-clipboard-list"></i> 訂單管理</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="info-div">
                <div class="info-content">
                    <div class="tabset">
                        <!-- Tab 1 -->
                        <input type="radio" name="tabset" id="tab1" aria-controls="basic-info" checked />
                        <label for="tab1">基本資料</label>
                        <!-- Tab 2 -->
                        <input type="radio" name="tabset" id="tab2" aria-controls="account-info" />
                        <label for="tab2">帳號資訊</label>
                        <!-- Tab 3 -->
                        <input type="radio" name="tabset" id="tab3" aria-controls="payment-info" />
                        <label for="tab3">付款資訊</label>
                        <div class="tab-panels">
                            <section id="basic-info" class="tab-panel">
                                <form method="post" id="user-info-form">
                                    <div class="user-pic">
                                        <img src="<%=request.getContextPath()%>/MembersServlet?mb_id=${member.mb_id}&action=getone_mbpic" alt="" />
                                        <input type="file" name="update-mbpic" id="update-mbpic">
                                    </div>
                                    <div class="user-infos">
                                        <label for="mb_name">姓名</label>
                                        <input
                                    ...
                                    <div class="user-infos">
                                        <label for="mb_address">居住地址</label>
                                        <input
                                            class="input-disabled"
                                            type="text"
                                            name="update-mbaddress"
                                            id="mb_address"
                                    ...
                                    <input style="display:none;" value="${member.mb_id}" name="update-mbid">
                            ...
                            <section id="account-info" class="tab-panel">
                                <form method="post" id="account-info-form">
                                    ...
                                    <div>
                                        <label for="mb_name">E-MAIL</label>
                                        <input
                                            class="input-disabled"
                                            type="text"
                                            name="mb_email"
                                    ...
                                    <div style="display: none" class="password_reset">
                                        <label for="mb_name">請輸入新密碼</label>
                                        <input
                                            class="input-disabled"
                                            type="password"
                                            name="new_mb_pwd"
                                    ...
                                    <div style="display: none" class="password_reset">
                                        <label for="mb_name">再次確認新密碼</label>
                                        <input
                                            class="input-disabled"
                                            type="password"
                                            name="confirm_new_mb_pwd"
                                            id="confirm_new_mb_pwd"
                                            pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                    ...
                                    <input style="display:none;" value="${member.mb_id}" name="mb_id">
                                	<div class="basic-info-buttons">
                                    <button type="button" class="btn btn-primary cancel-update">取消修改</button>
                            ...
                            <section id="payment-info" class="tab-panel">
                                <div class="creditcards">
                                    ...
                                    <div class="addnewcard creditcard">
                                        <i class="fas fa-plus-circle add-creditcard" id="add-creditcard"></i>
                                    </div>
                                </div>
                            </section>
                        </div>
