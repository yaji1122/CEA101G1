    ...
    <div class="box">
        <div id="card-container">
          ...
          <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00007&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1>蠻荒BBQ</h1>
              <p class="artist">特別活動</p>
              <p class="date">(BBQ)</p>
        ...
        <div id="card-container">
          <div id="card2">
            <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00008&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1><a href="#<%=request.getContextPath()%>/frontend/activity/Land_list2.jsp">深海巡禮</a></h1>
              <p class="artist">特別活動</p>
              <p class="date">(深潛)</p>
              <span class="icon-share">
                <a href="#" style="color:rgb(0, 0, 0)"><i class="fas fa-share-square"></i></a>
        ...
        <div id="card-container">
          <div id="card3">
           <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00009&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1>狩獵侏儸紀</h1>
