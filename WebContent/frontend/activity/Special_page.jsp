...
<body style="background-image:url('<%=request.getContextPath()%>/img/activity/bg1.png');">
	...
	<div class="box">
			...
			<div id="card">
				<c:forEach var="actVO" items="${actlist}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/ActServlet?actno=ACT0000007&action=get_actpic">
					</div>
					<div class="back face">
						<h1>蠻荒BBQ</h1>
						<p class="artist">特別行程</p>
						<p class="date">(BBQ)</p>
						...
						<div class="back-face-one">
							<p>
							  <c:if test="${actVO.actNo == 'ACT0000007'}">
							    ${actVO.actInfo}
							  </c:if>
							</p>
						</div>
		...
		<div id="card-container">
			...
			<div id="card2">
				<c:forEach var="actVO" items="${actlist}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/ActServlet?actno=ACT0000008&action=get_actpic">
					</div>
					<div class="back face">
						<h1>潛入深海</h1>
						<p class="artist">特別行程</p>
						...
						<div class="back-face-one">
							<p>
							  <c:if test="${actVO.actNo == 'ACT0000008'}">
							    ${actVO.actInfo}
							  </c:if>
                            </p>
						</div>
		...
		<div id="card-container">
			<div id="card3">
				<c:forEach var="actVO" items="${actlist}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/ActServlet?actno=ACT0000009&action=get_actpic">
					</div>
				<div class="back face">
					<h1>狩獵侏儸紀</h1>
					<p class="artist">特別行程</p>
					...
					<div class="back-face-one">
						<p>
						   <c:if test="${actVO.actNo == 'ACT0000009'}">
							    ${actVO.actInfo}
						   </c:if>
						</p>
					</div>
		...
		<div class="collapse" id="collapseExample">
			<c:forEach var="actVO" items="${actlist}">
				<c:if test="${actVO.actEventNo == 30 && actVO.actStatus == 1}">
					<div class="card card-body">
						...
						<div class="list-img">
							...
							<button type="button" class="btn btn-outline-dark make-res" id="${actVO.actNo}_btn"
								data-toggle="modal" data-target="#exampleModalCenter"  data-actno="${actVO.actNo}">
								我要預約</button>
						</div>
					</div>
				</c:if>
	...
	<script>
		$(document).ready(function(){
			...
			<c:forEach var="actVO" items="${actlist}">
			<c:if test="${actVO.actEventNo == 30 || actVO.actStatus == 0}">
