...
<link rel="stylesheet"
	...
	type="text/css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/slick.css" type="text/css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/slick-theme.min.css"
	type="text/css" />
<link rel="stylesheet"
...
<body>
						...
						<div class="nav-menu">
							<nav class="mainmenu">
								<ul>
									...
									<li><a href="shop.html" class="nav-evnet">特別行程</a></li>
								</ul>
							</nav>
						</div>
					</div>
	...
	<div id="slick">
		<c:forEach var="actVO" items="${list}">
			<div>
				<img
					src="<%=request.getContextPath()%>/act/ActPicReaderServlet?actEventNo=${actVO.actEventNo}&action=getOnePic">
			</div>
		</c:forEach>
	</div>
	<div class="box">
			...
			<div id="card">
				<c:forEach var="actPicVO" items="${list}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/act/ActPicReaderServlet?actEventNo=10&action=getOnePic">
					</div>
				</c:forEach>
				<div class="back face">
					<h1>Bouquet</h1>
					...
					<div class="back-face-one">
						<p>Lorem ipsum dolor sit, a met consectetur adipisicing elit.
							Accusamus libero eveniet, quisquam maxime ipsam rerum sequi nulla
							similique. Amet ut perspiciatis veniam cupiditate, officia
							excepturi optio eos sequi saepe possimus!</p>
						<p></p>
					</div>
				</div>
			</div>
		...
		<div id="card-container">
			<div id="card2">
				...
				<div class="back face">
					<h1>
						<a
							href="<%=request.getContextPath()%>/frontend/activity/Land_list2.jsp">百步穿楊</a>
					</h1>
		...
		<div id="card-container">
			<div id="card3">
				<c:forEach var="actPicVO" items="${list}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00003&action=getOnePic">
					</div>
				</c:forEach>
				<div class="back face">
					<h1>Waterbed</h1>
		...
		<p>
			<button class="btn btn-primary" type="button" data-toggle="collapse" style="margin-left: 500px;"
