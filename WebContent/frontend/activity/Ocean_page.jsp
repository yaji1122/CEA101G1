    ...
    <div class="box">
        <div id="card-container">
          ...
          <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00004&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1>暢遊大海</h1>
              <p class="artist">海上活動</p>
              <p class="date">(衝浪)</p>
        ...
        <div id="card-container">
          <div id="card2">
            <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00005&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1><a href="#<%=request.getContextPath()%>/frontend/activity/Land_list2.jsp">水世界</a></h1>
              <p class="artist">海上活動</p>
              <p class="date">(浮潛)</p>
              <span class="icon-share">
                <a href="#" style="color:rgb(0, 0, 0)"><i class="fas fa-share-square"></i></a>
        ...
        <div id="card-container">
          <div id="card3">
           <c:forEach var="actPicVO" items="${list}">
            <div class="front face">
              <img src="<%=request.getContextPath()%>/ActPicReaderServlet?actPicNo=00006&action=getOnePic">
            </div>
            </c:forEach>
            <div class="back face">
              <h1>與鯨共舞</h1>
