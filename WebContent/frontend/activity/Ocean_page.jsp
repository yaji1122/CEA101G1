...
<body style="background-image:url('<%=request.getContextPath()%>/img/activity/bg1.png');">
	...
	<div class="box">
			...
			<div id="card">
				<c:forEach var="actVO" items="${actlist}">
					<div class="front face">
						<img
							src="<%=request.getContextPath()%>/ActServlet?actno=ACT0000004&action=get_actpic">
					</div>
					<div class="back face">
						<h1>暢遊大海</h1>
						...
						<div class="back-face-one">
							<p>
							  <c:if test="${actVO.actNo == 'ACT0000004'}">
							    ${actVO.actInfo}
							  </c:if>
							</p>
						</div>
			...
			<div id="card2">
				<c:forEach var="actVO" items="${actlist}">
					...
					<div class="back face">
						...
						<div class="back-face-one">
							<p>
							  <c:if test="${actVO.actNo == 'ACT0000005'}">
							    ${actVO.actInfo}
							  </c:if>
                            </p>
						</div>
		...
		<div id="card-container">
			<div id="card3">
				...
				<div class="back face">
					...
					<div class="back-face-one">
						<p>
						   <c:if test="${actVO.actNo == 'ACT0000006'}">
							    ${actVO.actInfo}
						   </c:if>
						</p>
					</div>
		...
		<div class="collapse" id="collapseExample">
			<c:forEach var="actVO" items="${actlist}">
				<c:if test="${actVO.actEventNo == 20 && actVO.actStatus == 1}">
